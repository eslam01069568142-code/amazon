...
export default function HomepageProductGrid({ products, categories }: HomepageProductGridProps) {
  ...
  const filteredProducts = useMemo(() => {
    ...
    const parentMappings: Record<string, string[]> = {
      'الإلكترونيات': ['cat_1be31da10c3f', 'cat_uzhhuoj5g', 'cat_cameras', 'cat_power', 'cat_phones', 'cat_audio', 'cat_accessories', 'electronics', 'cat_8e59bb87ed5f', 'cat_9a096b3b0220', 'cat_f31c02663e8f', 'cat_92ca49512615', 'cat_c0d9f555671f', 'cat_fe83890f074a', 'cat_ce01ee96fa7e'],
      'المنزل والمطبخ': ['cat_9171ea6beb76', 'cat_mfufmoad0', 'cat_kitchenapps', 'cat_6d04c5ft6', 'cat_c4tky0yxa', 'cat_kitchentools', 'cat_u310yd1w3', 'cat_2zjelnsdg', 'home-kitchen', 'kitchen', 'cat_aaf0fbe22f26', 'cat_18c2760ea403', 'cat_661052da666a', 'cat_8203ce26b731', 'cat_2a87d8830611', 'cat_b9af786a4c81'],
      ...
      'الصحة والجمال': ['cat_56295eb8e5c3', 'cat_g3n6vkljv', 'cat_ut73yprlm', 'cat_bwoqca3kt', 'cat_o6r080tvi', 'cat_perfumes', 'cat_personalcare', 'cat_r826y1abx', 'health-beauty', 'cat_220d47ded76f', 'cat_5dc049f1d926', 'cat_756a54bd3bfb', 'cat_1fcbcb0752d8', 'cat_a04a69506302'],
      ...
      'الرياضة واللياقة': ['cat_6a64bea6eb28', 'cat_gnkssf8aq', 'cat_pqw2g6ac9', 'cat_ouk0kv2k7', 'cat_jiacjmtx3', 'sports', 'cat_3b7043e05588', 'cat_d67c0c44365c', 'cat_1048bbaea21f', 'cat_5fbc4caa8066'],
